...
class Contact extends Component {
  ...
  editButtonHandler = () => { 
    ...
    this.props.dispatch(updateContact({...this.state.contact, 'avatar': avatarPath, 'avatarName': this.state.avatarName}));
  }
        ...
        {this.state.listOpen && (
          <div className="contact-list">
            ...
            <div className="btn-container">
              ...
              <button id="btn-delete" onClick={() => this.deleteContactHandler(this.state.contact)}>Delete</button>
            </div>
          </div>
        )}
      </div>
